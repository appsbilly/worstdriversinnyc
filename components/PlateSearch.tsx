...
export function PlateSearch({
  ...
  const inputCls =
    "rounded-md border border-border bg-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 uppercase tracking-wider";
    ...
    <form onSubmit={submit} className="w-full">
      <div className="flex flex-col gap-2 md:flex-row md:items-stretch">
        ...
        <input
          ...
          spellCheck={false}
          maxLength={10}
          className={cn(inputCls, size === "hero" ? heroInput : defaultInput, "flex-1")}
        ...
        <button
          ...
          disabled={loading}
          className={cn(
            "rounded-md bg-foreground px-6 text-sm font-medium text-background transition hover:opacity-90 disabled:opacity-50",
