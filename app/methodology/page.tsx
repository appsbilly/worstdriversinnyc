...
export default function MethodologyPage() {
  return (
    <article className="container max-w-2xl py-12 prose-neutral">
      <h1 className="font-serif text-4xl font-black tracking-tight md:text-5xl">methodology</h1>
      ...
      <Section title="how the rank is computed">
        <p>
          we count violations per plate across the data window, then assign{" "}
          <span className="italic">standard competition ranking</span>: plates tied at the
          same violation count share a rank, and the next distinct count skips by the size
          of the tie group. rank #1 is the most-ticketed plate.
        </p>
      </Section>
      ...
      <Section title="what's missing">
        <ul className="list-disc pl-5 space-y-1">
          <li>
            ...
            ticket roughly 22% of offending vehicles in early 2023 due to obscured plates.
          </li>
          <li>dismissed or overturned violations may still appear in the dataset.</li>
          <li>
      ...
      <Section title="legal">
        ...
        <p className="mt-3">
          if you believe a record should be removed, file a takedown request through the
          underlying open-data portal — that is the system of record, and any correction
          propagates here on the next refresh.
        </p>
      </Section>
    </article>
  );
